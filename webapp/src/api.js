...
export const api = {
  ...
  markUyqurLearnedBatch: payload => request('uyqurMarkLearnedBatch', { method: 'POST', body: payload }).then(r => r.data),
  markUyqurActionLearned: payload => request('uyqurActionMarkLearned', { method: 'POST', body: payload }).then(r => r.data),
  markUyqurActionLearnedBatch: payload => request('uyqurActionMarkLearnedBatch', { method: 'POST', body: payload }).then(r => r.data),
  confirmUyqurReview: payload => request('uyqurConfirmReview', { method: 'POST', body: payload }).then(r => r.data),
  confirmUyqurReviewBatch: payload => request('uyqurConfirmReviewBatch', { method: 'POST', body: payload }).then(r => r.data),
  confirmUyqurActionReview: payload => request('uyqurActionConfirmReview', { method: 'POST', body: payload }).then(r => r.data),
  confirmUyqurActionReviewBatch: payload => request('uyqurActionConfirmReviewBatch', { method: 'POST', body: payload }).then(r => r.data),
