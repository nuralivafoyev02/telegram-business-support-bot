...
function handleDocumentKeydown(event) {
  if (event.key === 'Escape') {
    ...
    if (managementModal.value) closeManagementModal();
  }
}
...
async function openMyOpenRequests() {
  try {
    // Superadmin bosh sahifasidagi "Javobsiz" kartasi bilan bir xil bo'lishi
    // uchun davr (period) qo'llaniladi. Lichka (shaxsiy) chatlar bu hisobga
    // kirmaydi — faqat guruh (kompaniya) chatlaridagi ochiq so'rovlar sanaladi.
...
// har bir modul uchun o'zimizning chiziq-ikonka (SVG) to'plamimiz ishlatiladi —
// shunda barcha qurilmalarda bir xil, aniq va toza ko'rinadi.
const MODULE_ICON_SHAPES = {
  kassa: '<rect x="2.5" y="6.5" width="19" height="11" rx="2.2"/><circle cx="12" cy="12" r="2.4"/><line x1="5.5" y1="9.5" x2="5.6" y2="9.5"/><line x1="18.5" y1="14.5" x2="18.4" y2="14.5"/>',
  ombor: '<polygon points="12 3 21 7.5 21 16.5 12 21 3 16.5 3 7.5"/><polyline points="3 7.5 12 12 21 7.5"/><line x1="12" y1="12" x2="12" y2="21"/>',
  omborxona: '<polygon points="12 3 21 7.5 21 16.5 12 21 3 16.5 3 7.5"/><polyline points="3 7.5 12 12 21 7.5"/><line x1="12" y1="12" x2="12" y2="21"/>',
  taminot: '<circle cx="9.5" cy="20" r="1.4"/><circle cx="18" cy="20" r="1.4"/><path d="M2.5 3h2l2.3 12a2 2 0 0 0 2 1.6h8.4a2 2 0 0 0 2-1.6L21 7.5H6.2"/>',
  monitoring: '<rect x="3" y="4.5" width="18" height="12" rx="2"/><line x1="8" y1="20" x2="16" y2="20"/><line x1="12" y1="16.5" x2="12" y2="20"/>',
  sotuv: '<path d="M6.5 8V6.2a5.5 5.5 0 0 1 11 0V8"/><rect x="3.2" y="8" width="17.6" height="12.5" rx="2"/><line x1="8.5" y1="12" x2="8.5" y2="12"/><line x1="15.5" y1="12" x2="15.5" y2="12"/>',
  moliya: '<line x1="4.5" y1="20" x2="4.5" y2="13"/><line x1="10.5" y1="20" x2="10.5" y2="8.5"/><line x1="16.5" y1="20" x2="16.5" y2="4.5"/><line x1="3" y1="20" x2="21" y2="20"/>',
  hrm: '<circle cx="9" cy="8.2" r="3"/><path d="M3.2 20c0-3.2 2.6-5.8 5.8-5.8s5.8 2.6 5.8 5.8"/><circle cx="17.3" cy="9.3" r="2.3"/><path d="M15.8 14.4c2.3.5 4 2.4 4.2 4.9"/>',
  kontragent: '<rect x="2.5" y="8" width="19" height="12" rx="2"/><path d="M8.2 8V6.3a1.8 1.8 0 0 1 1.8-1.8h4a1.8 1.8 0 0 1 1.8 1.8V8"/><line x1="2.5" y1="13.2" x2="21.5" y2="13.2"/>',
  kontragentbalansi: '<path d="M6.5 3h8l3.5 3.4V21h-11.5z"/><line x1="9" y1="8.5" x2="15.5" y2="8.5"/><line x1="9" y1="12.3" x2="15.5" y2="12.3"/><line x1="9" y1="16.1" x2="13" y2="16.1"/>',
  loyiha: '<path d="M3.2 7a2 2 0 0 1 2-2h4l2 2h7.6a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H5.2a2 2 0 0 1-2-2z"/>',
  inventar: '<rect x="3" y="4" width="18" height="4.6" rx="1.1"/><path d="M5 8.6V18a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V8.6"/><line x1="10" y1="13.2" x2="14" y2="13.2"/>',
  sozlamalar: '<circle cx="12" cy="12" r="3"/><line x1="12" y1="2.5" x2="12" y2="5.2"/><line x1="12" y1="18.8" x2="12" y2="21.5"/><line x1="2.5" y1="12" x2="5.2" y2="12"/><line x1="18.8" y1="12" x2="21.5" y2="12"/><line x1="5.1" y1="5.1" x2="7" y2="7"/><line x1="17" y1="17" x2="18.9" y2="18.9"/><line x1="5.1" y1="18.9" x2="7" y2="17"/><line x1="17" y1="7" x2="18.9" y2="5.1"/>',
  dashboard: '<rect x="3" y="3" width="7.5" height="7.5" rx="1.3"/><rect x="13.5" y="3" width="7.5" height="7.5" rx="1.3"/><rect x="3" y="13.5" width="7.5" height="7.5" rx="1.3"/><rect x="13.5" y="13.5" width="7.5" height="7.5" rx="1.3"/>',
  ishlar: '<line x1="9.5" y1="6" x2="20.5" y2="6"/><line x1="9.5" y1="12" x2="20.5" y2="12"/><line x1="9.5" y1="18" x2="20.5" y2="18"/><path d="M3.5 6l1.3 1.3 2.2-2.2"/><path d="M3.5 12l1.3 1.3 2.2-2.2"/><path d="M3.5 18l1.3 1.3 2.2-2.2"/>',
  xizmat: '<path d="M12 3.2a5.8 5.8 0 0 0-5.8 5.8v3.5L4.6 15.6h14.8L17.8 12.5V9a5.8 5.8 0 0 0-5.8-5.8z"/><path d="M10.1 18.8a1.9 1.9 0 0 0 3.8 0"/>',
  xizmatlar: '<path d="M12 3.2a5.8 5.8 0 0 0-5.8 5.8v3.5L4.6 15.6h14.8L17.8 12.5V9a5.8 5.8 0 0 0-5.8-5.8z"/><path d="M10.1 18.8a1.9 1.9 0 0 0 3.8 0"/>',
  shartnomalar: '<path d="M6.5 3h8l3.5 3.4V21h-11.5z"/><line x1="9" y1="9" x2="15.5" y2="9"/><line x1="9" y1="13" x2="13.5" y2="13"/><path d="M9.2 16.6l1.7 1.7 3.4-3.4"/>'
};
const MODULE_ICON_DEFAULT_SHAPE = '<circle cx="12" cy="12" r="8.2"/><line x1="12" y1="8" x2="12" y2="16"/><line x1="8" y1="12" x2="16" y2="12"/>';

const MODULE_ICON_META = {
  kassa: { bg: '#fef3c7', color: '#d97706' },
  ombor: { bg: '#ede9fe', color: '#7c3aed' },
  omborxona: { bg: '#ede9fe', color: '#7c3aed' },
  taminot: { bg: '#dbeafe', color: '#2563eb' },
  monitoring: { bg: '#cffafe', color: '#0891b2' },
  sotuv: { bg: '#fce7f3', color: '#db2777' },
  moliya: { bg: '#d1fae5', color: '#059669' },
  hrm: { bg: '#e5e7eb', color: '#4b5563' },
  kontragent: { bg: '#ffedd5', color: '#ea580c' },
  kontragentbalansi: { bg: '#fdf2f8', color: '#be185d' },
  loyiha: { bg: '#fef9c3', color: '#ca8a04' },
  inventar: { bg: '#e0f2fe', color: '#0284c7' },
  sozlamalar: { bg: '#f1f5f9', color: '#475569' },
  dashboard: { bg: '#eff6ff', color: '#1d4ed8' },
  ishlar: { bg: '#fefce8', color: '#a16207' },
  xizmat: { bg: '#f0fdf4', color: '#16a34a' },
  xizmatlar: { bg: '#f0fdf4', color: '#16a34a' },
  shartnomalar: { bg: '#faf5ff', color: '#7e22ce' }
};
const MODULE_ICON_DEFAULT = { bg: '#f3f4f6', color: '#6b7280' };

function moduleIconMeta(name = '') {
  // Apostrof/bo'shliq/raqamlar olib tashlanadi — masalan "Ta'minot" va
  // "Kontragent balansi" ham to'g'ri kalitga (taminot, kontragentbalansi) mos kelsin.
